      ...
      <ReactLenis root>
        ...
        <div id="hero" data-section="hero">
          <HeroCentered
            ...
            avatars={[
              { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZaIKn9WWXlxgjSGQ2zFAQbuQz/portrait-of-a-confident-professional-in--1774878307877-deda2ae8.png", alt: "Client 1" },
              { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZaIKn9WWXlxgjSGQ2zFAQbuQz/portrait-of-a-creative-entrepreneur-shar-1774878308856-5ecb9240.png", alt: "Client 2" },
              { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZaIKn9WWXlxgjSGQ2zFAQbuQz/portrait-of-a-tech-industry-founder-clea-1774878309272-c09f1280.png", alt: "Client 3" },
              { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZaIKn9WWXlxgjSGQ2zFAQbuQz/portrait-of-a-successful-marketer-warm-l-1774878308581-a40f6e03.png", alt: "Client 4" },
              { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZaIKn9WWXlxgjSGQ2zFAQbuQz/portrait-of-a-confident-professional-in--1774878307877-deda2ae8.png", alt: "Client 5" }
            ]}
            buttons={[{ text: "Get Started", href: "#contact" }]}
            buttonAnimation="slide-up"
            marqueeItems={[
              { type: "text", text: "AI-Driven Insights" },
              { type: "text", text: "Viral Content Lab" },
              { type: "text", text: "Global Brand Reach" },
              { type: "text", text: "Targeted Ad Ops" },
              { type: "text", text: "Data Growth Engine" }
            ]}
          />
        </div>
        ...
        <div id="social-proof" data-section="social-proof">
          <SocialProofOne
            ...
            names={["Nexus", "Aura", "Vertex", "Prime", "Lumina", "Zenith", "Flux"]}
            title="Trusted by visionary brands"
            description="Partnering with industry leaders to deliver exceptional results."
          />
        </div>
        ...
        <div id="features" data-section="features">
          <FeatureCardTwentySeven
            ...
            useInvertedBackground={false}
            features={[
              { id: "1", title: "Data Analytics", description: "Turn complex data into actionable insights.", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZaIKn9WWXlxgjSGQ2zFAQbuQz/abstract-visualization-of-data-analytics-1774878310970-d138b868.png" },
              { id: "2", title: "Content Production", description: "World-class visual assets that convert.", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZaIKn9WWXlxgjSGQ2zFAQbuQz/creative-content-strategy-illustration-v-1774878314186-ac6d0174.png" },
              { id: "3", title: "Audience Targeting", description: "Reach your perfect customers precisely.", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZaIKn9WWXlxgjSGQ2zFAQbuQz/target-audience-illustration-digital-net-1774878308832-8593620f.png" }
            ]}
        ...
        <div id="pricing" data-section="pricing">
          <PricingCardEight
            ...
            useInvertedBackground={false}
            plans={[
              { id: "1", badge: "Essential", price: "$3,000", subtitle: "Basic social presence management", features: ["1 platform", "Content planning", "Reporting"], buttons: [{ text: "Enquire" }] },
              { id: "2", badge: "Growth", price: "$6,500", subtitle: "Full scale strategy & production", features: ["3 platforms", "Full video production", "Paid ad management"], buttons: [{ text: "Enquire" }] },
              { id: "3", badge: "Premium", price: "$12,000", subtitle: "Elite agency-in-a-box", features: ["All platforms", "Custom strategy", "Executive reporting"], buttons: [{ text: "Enquire" }] }
            ]}
            title="Transparent Growth Plans"
            description="Flexible tiers to help you grow your brand."
          />
        </div>
        ...
        <div id="footer" data-section="footer">
          <FooterBase
            columns={[
              ...
              { title: "Services", items: [{ label: "Content", href: "#features" }, { label: "Strategy", href: "#features" }] },
